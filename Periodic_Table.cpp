...
void particular()
{
	...
	getch();
	system("cls");
	cout<<"\n\tHow do you want to see details of the element\n\t";
	cout<<"press\n\t1.Atomic number\n\t2.Element name\n\t";
	cout<<"\n\tEnter your choice : ";
	cin>>w;
//	switch(w)
...
void initializing()
{
    ...
    strcpy(elem[113].name,"Nihonium- Nh");       
    strcpy(elem[114].name,"Flerovium- Fl");      
    strcpy(elem[115].name,"Moscovium- Mc");      
    strcpy(elem[116].name,"Livermorium- lv");    
    strcpy(elem[117].name,"Tennessine- Ts");     
    strcpy(elem[118].name,"Oganesson- Og");      
                    
                               //initializing eletronic configuration.
    ...
    strcpy(elem[115].ec,"[Rn] 5f14 6d10 7s2 7p3");
    strcpy(elem[116].ec,"[Rn] 5f14 6d10 7s2 7p4");
    strcpy(elem[117].ec,"[Rn] 5f14 6d10 7s2 7p5");
    strcpy(elem[118].ec,"[Rn] 5f14 6d10 7s2 7p6");
...
int main()
{
	...
	cout<<"\n\t\t****************************************";
	cout<<"\n\t\t*                                      *";
	cout<<"\n\t\t*  Program releated to periodic table  * ";
	cout<<"\n\t\t*                                      *";
	cout<<"\n\t\t****************************************";
	Sleep(3000);
	for(i=1;i<=100;i++)
	{
		...
		cout<<"This program is made by    :   KESHAV SHARMA\n\n\n\n\n\n\n\n\t\t\t\t\t\t";
		cout<<"Loading : "<<i<<" %";
		if(i==100)
		{
			Sleep(2000);
	...
	fstream f("D:/programming files/periodic_table.dat",ios::in|ios::out|ios::binary);
	if(f.fail())
	{
		cout<<"\n\tunable to open file\n\t";
		return 0;
	...
	do
	{
	    ...
	    cout<<"2.Details of a particular element\n\t";
	    cout<<"3.Play quiz\n\t";
	    ...
	    cout<<"Enter any another key for exit\n\t";
	    cin>>choice;
